...
export const DASHBOARD_DATA = {
  'family-parent': {
    ...
    transactions: [
      ...
      { id: 't4', name: 'Electricity bill', nameAr: 'فاتورة الكهرباء', category: 'Utilities', amount: -98.3, date: daysAgo(3), icon: 'zap' },
      { id: 't5', name: 'Pediatrician — Mira', nameAr: 'طبيبة الأطفال — ميرا', category: 'Children', amount: -55, date: daysAgo(4), icon: 'heart' },
      { id: 't6', name: 'Side project', nameAr: 'مشروع جانبي', category: 'Income', amount: 320, date: daysAgo(5), icon: 'briefcase' },
      { id: 't7', name: 'Pharmacy', nameAr: 'الصيدلية', category: 'Health', amount: -38.4, date: daysAgo(6), icon: 'plus' },
      { id: 't8', name: 'Internet — Orange', nameAr: 'الإنترنت — أورنج', category: 'Utilities', amount: -42, date: daysAgo(7), icon: 'wifi' },
    ],
    goals: [
  ...
  'school-student': {
    ...
    kpis: {
      balance: { value: 138, delta: 12.4, sub: 'in your wallet', subAr: 'في محفظتك' },
      ...
      savings: { value: 220, delta: 18.6, sub: 'phone fund', subAr: 'صندوق التلفون' },
    },
    ...
    goals: [
      { id: 'g1', name: 'New phone', nameAr: 'تلفون جديد', target: 600, saved: 220, deadline: 'Sep 2026', deadlineAr: 'أيلول ٢٠٢٦', icon: 'smartphone' },
      { id: 'g2', name: 'Football boots', nameAr: 'بسطار كرة قدم', target: 80, saved: 35, deadline: 'Jun 2026', deadlineAr: 'حزيران ٢٠٢٦', icon: 'circle' },
      { id: 'g3', name: 'Online drawing course', nameAr: 'كورس رسم أونلاين', target: 45, saved: 45, deadline: 'Done', deadlineAr: 'تم', icon: 'palette' },
    ],
    bills: [
  ...
  'university-student': {
    ...
    kpis: {
      ...
      income: { value: 1100, delta: 15.0, sub: 'allowance + tutoring', subAr: 'مصروف + دروس' },
    ...
    cashflow: cashflow(1080, 940, 120, 90),
    categories: [
      { name: 'Rent / dorm', value: 380, color: '#6366f1' },
      { name: 'Food', value: 220, color: '#10b981' },
      { name: 'Transport', value: 90, color: '#0ea5e9' },
      { name: 'Books', value: 130, color: '#f59e0b' },
      { name: 'Subs & fun', value: 95, color: '#ec4899' },
      { name: 'Other', value: 65, color: '#94a3b8' },
    ],
    transactions: [
      { id: 't1', name: 'Tutoring — Math 1A', nameAr: 'دروس خصوصية — رياضيات', category: 'Income', amount: 60, date: daysAgo(0), icon: 'briefcase' },
      { id: 't2', name: 'Lunch — Bun & Co', nameAr: 'غداء — Bun & Co', category: 'Food', amount: -8.5, date: daysAgo(1), icon: 'utensils' },
      { id: 't3', name: 'Dorm fee — April', nameAr: 'سكن جامعي — نيسان', category: 'Rent', amount: -380, date: daysAgo(2), icon: 'home' },
      { id: 't4', name: 'Calculus textbook', nameAr: 'كتاب التفاضل', category: 'Books', amount: -45, date: daysAgo(3), icon: 'book' },
      { id: 't5', name: 'Allowance', nameAr: 'المصروف', category: 'Income', amount: 600, date: daysAgo(4), icon: 'gift' },
      { id: 't6', name: 'Bus pass', nameAr: 'اشتراك الباص', category: 'Transport', amount: -28, date: daysAgo(5), icon: 'bus' },
      { id: 't7', name: 'Spotify Premium', nameAr: 'سبوتيفاي بريميوم', category: 'Subs', amount: -4.99, date: daysAgo(6), icon: 'music' },
      { id: 't8', name: 'Coffee with study group', nameAr: 'قهوة مع مجموعة الدراسة', category: 'Food', amount: -3.2, date: daysAgo(7), icon: 'utensils' },
    ],
    goals: [
      { id: 'g1', name: 'Laptop upgrade', nameAr: 'لابتوب جديد', target: 1200, saved: 380, deadline: 'Sep 2026', deadlineAr: 'أيلول ٢٠٢٦', icon: 'monitor' },
      { id: 'g2', name: 'Summer trip', nameAr: 'رحلة الصيف', target: 900, saved: 240, deadline: 'Jul 2026', deadlineAr: 'تموز ٢٠٢٦', icon: 'plane' },
      { id: 'g3', name: '3-month buffer', nameAr: 'احتياطي ٣ شهور', target: 2400, saved: 720, deadline: 'Dec 2026', deadlineAr: 'كانون١ ٢٠٢٦', icon: 'shield' },
    ],
    bills: [
      { id: 'b1', name: 'Dorm fee', nameAr: 'السكن الجامعي', amount: 380, due: inDays(4), status: 'upcoming', icon: 'home' },
      { id: 'b2', name: 'Phone plan', nameAr: 'باقة الهاتف', amount: 18, due: inDays(7), status: 'upcoming', icon: 'phone' },
      { id: 'b3', name: 'Spotify', nameAr: 'سبوتيفاي', amount: 4.99, due: inDays(12), status: 'upcoming', icon: 'music' },
      { id: 'b4', name: 'Notion AI', nameAr: 'Notion AI', amount: 8, due: inDays(18), status: 'upcoming', icon: 'sparkles' },
    ],
    alerts: [
      { severity: 'warning', title: 'Food spend rising', titleAr: 'مصروف الأكل مرتفع', body: "You're eating out more this week. Cooking 2 dinners would save ~$22.", bodyAr: 'بتاكل برّا أكتر هالأسبوع. لو طبخت عشاءين رح توفر ٢٢$ تقريباً.' },
      { severity: 'info', title: 'Tutoring: +$60 this week', titleAr: 'دروس خصوصية: +٦٠$ هذا الأسبوع', body: 'Side income covers ~7% of your monthly expenses — nice.', bodyAr: 'الدخل الجانبي بيغطي ٧٪ من مصاريفك الشهرية — حلو.' },
      { severity: 'success', title: 'Buffer goal: 30%', titleAr: 'هدف الاحتياطي: ٣٠٪', body: "You're on track to hit a 3-month safety net by December.", bodyAr: 'على المسار للوصول لاحتياطي ٣ شهور بحلول كانون الأول.' },
    ],
    budgets: [
      { category: 'Food', icon: 'utensils', color: '#10b981', spent: 220, limit: 250 },
...
export const ROLE_EXTRAS = {
  ...
  'school-student': {
    badges: [
      ...
      { key: 'phoneHalf', color: '#f59e0b', icon: 'smartphone', earned: false },
    ],
    parentMode: { enabled: true, parentName: 'Mom', parentNameAr: 'ماما' },
  },
  'university-student': {
    sideIncome: [
      { source: 'Tutoring', sourceKey: 'srcTutoring', amount: 240 },
      { source: 'Campus job', sourceKey: 'srcCampus', amount: 320 },
      { source: 'Freelance', sourceKey: 'srcFreelance', amount: 90 },
    ],
  },
  employee: {
